  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 13, color: 'var(--text-dim)', marginBottom: 24 }}>
        Add or update past predictions for any user on completed matches. Points are recalculated automatically.
      </p>
      ...
      {selectedUserId && (
        <>
          <h3 style={{ fontSize: 14, fontWeight: 600, marginBottom: 12, color: 'var(--text-dim)' }}>
            {loadingPreds ? 'Loading…' : `${matches.length} completed matches for ${selectedUser?.displayName}`}
          </h3>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    padding: '12px 16px',
                    background: 'var(--bg-1)', border: isExact ? '2px solid #d4a017' : '1px solid var(--line)',
